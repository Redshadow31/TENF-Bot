        ...
        yield interaction.reply({
            embeds: [
                new DraftBotEmbed_1.DraftBotEmbed()
                    .setTitle(i18n_1.default.t("commands:vote.title", { lng }))
                    .setDescription(i18n_1.default.t("commands:vote.description", { lng }))
            ]
        });
        return null;
    });
...
exports.commandInfo = {
    slashCommandBuilder: SlashCommandBuilderGenerator_1.SlashCommandBuilderGenerator.generateBaseCommand("vote"),
    getPacket,
